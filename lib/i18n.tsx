...
const translations = {
  en: {
    ...
    saveAsJSON: "Save family tree as JSON backup",
    importData: "Import Data",
    restoreFromBackup: "Restore from JSON backup file",
    ...
    createBackupDesc: "Save your family data as a JSON file",
  ...
  bm: {
    ...
    saveAsJSON: "Simpan salasilah sebagai sandaran JSON",
    importData: "Import Data",
    restoreFromBackup: "Pulihkan dari fail sandaran JSON",
    ...
    createBackupDesc: "Simpan data keluarga sebagai fail JSON",
